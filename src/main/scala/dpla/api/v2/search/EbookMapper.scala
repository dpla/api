...
import dpla.api.v2.search.SearchProtocol.{EbookFetchResult, EbookMultiFetchResult, EbookSearchResult, FetchQueryResponse, IntermediateSearchResult, MultiFetchQueryResponse, SearchFailure, SearchQueryResponse}
import spray.json._
